...
| --- | --- |
| `aart-data-analysis-36mo-robust.R` | Replication code to reproduce AART 2017-3 robustness analysis |
| `aart-data-analysis-36mo.R` | Replication code to reproduce AART 2017-3 application results |
| `aart-data-analysis-60mo-robust.R` | Replication code to reproduce AART 2017-3 robustness analysis |
| `aart-data-analysis-60mo.R` | Replication code to reproduce AART 2017-3 application results |
| `aart-data-g-est-manu-graph.R` | Replication code to reproduce AART 2017-3 application results |
| `aart-data-lifetime-calibration.R` | Replication code to reproduce AART 2017-3 application results |
