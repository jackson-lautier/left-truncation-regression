...
reg.data = read.csv("./processed-data/aart-2017-36mo-robust.csv")
reg.data = reg.data[,-1]
...
write.csv(H, "./results/aart-hessian-36mo-robust.csv")
write.csv(results, "./results/aart-est-36mo-robust.csv")
...
hessian = read.csv("./results/aart-hessian-36mo-robust.csv")
hessian = hessian[,-1]
aart.est = read.csv("./results/aart-est-36mo-robust.csv")
aart.est = aart.est[,-1]
...
write.csv(aart.est, "./results/aart-est-36mo-robust.csv")
